...
![Donation widget — Achylo orange progress bar and pill Donate button (DM Sans typography)](../assets/images/donation-widget.svg)

**Visual style (matches the Home screen):**

- Typography: **DM Sans**, `font-weight: 500` — thin, elegant headings and labels
- Colors: text `#1a1a1a` / `#6b6b6b`, accent **orange** `#ff7f41`
- Progress bar and **Donate** button: orange pill shape (`border-radius: 999px`)
